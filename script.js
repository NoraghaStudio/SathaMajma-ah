...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mapElement && typeof L !== 'undefined') {
        // Center the map around Sudair region
        const map = L.map('areasMap').setView([25.75, 45.60], 9);
        ...
        const locations = [
            { name: "المجمعة (المقر الرئيسي)", coords: [25.9038, 45.3340] },
            { name: "جلاجل", coords: [25.6797, 45.4572] },
            { name: "حوطة سدير", coords: [25.5983, 45.6178] },
            { name: "عشيرة سدير", coords: [25.6416, 45.5458] },
            { name: "روضة سدير", coords: [25.5683, 45.6183] },
            { name: "تمير", coords: [25.7083, 45.8694] }
        ];
